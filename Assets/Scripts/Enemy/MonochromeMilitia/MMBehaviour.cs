...
public class MMBehaviour : MonoBehaviour
{
    ...
    IEnumerator ShootRoutine()
    {
        ...
        targetPos += new Vector3(Random.Range(-projectileSpread, projectileSpread), Random.Range(-projectileSpread, projectileSpread), Random.Range(-projectileSpread, projectileSpread));
